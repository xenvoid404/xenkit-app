...
export function ThemeToggle() {
    ...
    return (
        <button
            ...
            className="relative flex h-10 w-10 items-center justify-center rounded-full bg-muted/20 hover:bg-muted/40 hover:scale-105 active:scale-95 transition-all duration-300 group"
        >
