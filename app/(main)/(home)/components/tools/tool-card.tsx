...
export function ToolCard({ tool, className }: ToolCardProps) {
    ...
    return (
        <article className="group relative overflow-hidden rounded-xl bg-background/70 backdrop-blur-sm border border-border/50 p-6 transition-all duration-300 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/10 hover-lift hover-scale-sm">
